  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <div className="text-center">
        ...
        <p className="text-aetheric-gold-400 font-body mb-3">Master Alchemist & Mystic</p>
        ...
        <div className="panel-steampunk rounded-xl p-4 border border-brass-500/30">
          <p className="text-sm text-brass-200 font-body italic">
            "Ah, welcome to my mystical laboratory, young apprentice! The ancient arts of transmutation and botanical alchemy await your discovery."
          </p>
        </div>
      </div>
    </div>
